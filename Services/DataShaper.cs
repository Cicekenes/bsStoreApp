...
namespace Services
{
    ...
    {
        //Property'leri tek bir dizide tutabilmemiz adına array şeklinde verdik
        ...
        //Seçilen elemanların bir listesini üretiriz.
        private IEnumerable<PropertyInfo> GetRequiredProperties(string fieldString)
        {
            ...
            {
                //ikinci parametre ile boş olan parametreleri kaldır
            ...
            {
                //Tüm alanları query string'e taşımız olacağız
