...
namespace Services
{
    public class AuthenticationManager : IAuthenticationService
    {
        ...
        public async Task<TokenDto> CreateToken(bool populateExpire)
        {
            ...
            var signinCredentials = GetSigninCredenditials();
            //kullanıcının hakları yani talepleri = rolleri vs.
            var claims = await GetClaims();
            //Token seçeneklerini alacağız
        ...
        private SigningCredentials GetSigninCredenditials()
        {
        ...
        //kullanıcı bilgilerine ihtiyaç vardır.
        private ClaimsPrincipal GetPrincipalFromExpiredToken(string token)
        {
            ...
            //security token gibi davran. Casting. 
